...
def IP_net():
    ...
    def model_fn(x):
        ...
        """
        return hyper3d_net(x, reuse=tf.AUTO_REUSE, psis=[psi,psi],
...
def hyper_run_acc(data, labels, netO, traintestfilenames=None):
    """
    ...
    for traintestfilename in traintestfilenames:
        ...
        hdf5storage.write(mat_outdata, filename=os.path.join(DATA_PATH, traintestfilename+'_pyFST3D_expt.mat'), matlab_compatible=True)
