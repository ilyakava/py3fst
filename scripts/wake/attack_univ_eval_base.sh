...
CUDA_VISIBLE_DEVICES=0 python attack_eval.py \
    ...
    --batch_size 32 \
    --n_eval_batches 224 \
    --load_noise data/sec_corticaltest.wav \
    --save_suffix dirty
    


rsync -rv /vulcanscratch/ilyak/experiments/wake_tf_board/baseline_v718_bs64_trial2/len124_export/ ramawks69:/scratch0/ilya/locDownloads/baseline_music_adv_test
