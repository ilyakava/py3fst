...
--model_root=/vulcanscratch/ilyak/experiments/wake_tf_board/baseline_specnoclip_bs64 \
--train_data_root /vulcanscratch/ilyak/data/alexa/v7.10/train_79840 \
--val_data_root /vulcanscratch/ilyak/data/alexa/v7.10/val_19680 \
