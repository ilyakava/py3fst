...
--log_dir=/scratch0/ilya/locDownloads/temp_v715_cortical_model_res1c_drop7/export/FAR_exporter \
--exported_model_glob='/scratch0/ilya/locDownloads/temp_v715_cortical_model_res1c_drop7/export/FAR_exporter/*' \
--attack_norm inf \
--attack_eps 0.0001 \
