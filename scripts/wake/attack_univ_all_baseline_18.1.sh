...
rsync -v /vulcanscratch/ilyak/experiments/wake_tf_board/baseline_v718_bs64_trial3/export/best_loss_exporter/*npz ramawks69:/scratch0/ilya/locDownloads/baseline_v718_bs64_trial3/