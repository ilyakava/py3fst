...
do
    ...
    --model_root=/vulcanscratch/ilyak/experiments/wake_tf_board/baseline_v718_bs64/export/best_loss_exporter/ \
    --max_steps 4000 \
    --eval_period 400 \
...
# rsync /vulcanscratch/ilyak/experiments/wake_tf_board/baseline_v718_bs64_trial2/export/best_loss_exporter/*npz ramawks69:/scratch0/ilya/locDownloads/baseline_v718_bs64_trial2/