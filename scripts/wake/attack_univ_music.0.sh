# this makes the chords with adversarial noise

# export MODEL_DIR=/vulcanscratch/ilyak/experiments/adv_music/cort_net_1/len31_export/
# export MODEL_DIR=/vulcanscratch/ilyak/experiments/adv_music/base_net_1/len31_export/
