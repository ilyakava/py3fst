...
--export_only_dir /scratch0/ilya/locDoc/adv_audio_exports/len500_loss_normalv7 \
--warm_start_from /scratch0/ilya/locDoc/adv_audio_tf_board/normal_bs64_05.02_v7/export/best_loss_exporter/1588509565
